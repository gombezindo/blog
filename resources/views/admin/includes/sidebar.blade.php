   ...
   <section class="sidebar">
    ...
    <div id="mainMenu">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('admin.university.index') }}"><i class="fa fa-university text-purple"></i> <span>University</span></a></li>
        <li><a href="{{ route('admin.courses.index') }}"><i class="fa fa-book text-purple"></i> <span>Courses</span></a></li>
        <li><a href="{{ route('admin.task.index') }}"><i class="fa fa-tasks text-purple"></i> <span>Create Task</span></a></li>
        <li><a href="{{ route('admin.profile.index') }}"><i class="fa fa-clone text-purple"></i> <span>Upload Check</span></a></li>
