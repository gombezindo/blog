        ...
        <div class="about-us">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="notelp" class="form-control" id="name" value="{{ old('notelp') }}" placeholder="notelp">
                ...
                <div class="form-group{{ $errors->has('university') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="university" class="form-control" id="university" value="{{ old('university') }}" placeholder="university">
                ...
                <div class="form-group{{ $errors->has('major') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="major" class="form-control" id="major" value="{{ old('major') }}" placeholder="Email">
                    @if ($errors->has('major'))
                    <span class="help-block">
